...
var input_search_product, input_fecha_nacimiento, input_date_joined, input_cash, input_change;
...
$(function () {
    ...
    $('select[name="genero"]').select2({
        language: 'es',
        theme: 'bootstrap4',
        dropdownParent: $('#myModalCliente')
    });
    ...
    $('.btnAddCliente').on('click', function () {
        input_fecha_nacimiento.datetimepicker('date', new Date());
    ...
    $('#frmCliente').on('submit', function (e) {
        ...
        var args = {
            ...
            'success': function (request) {
                select_cliente.select2('trigger', 'select', { data: request });
